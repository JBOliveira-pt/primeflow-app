                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <label
                                htmlFor="imageFile"
                                className="flex flex-col items-center justify-center w-full h-20 border-2 border-gray-700 border-dashed rounded-lg cursor-pointer bg-gray-800 hover:bg-gray-800/80 hover:border-purple-500/50 transition-all group"
                            >
                                <div className="flex items-center gap-3">
                                    <ArrowPathIcon className="w-6 h-6 text-gray-500 group-hover:text-purple-400 transition-colors" />
                                    <div>
