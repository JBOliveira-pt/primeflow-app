    ...
    <div className="w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
      <div className="text-center mb-8">
        <div className="w-18 h-18 flex items-center justify-center mx-auto">
          <Image src="/images/primeflow-whiteroundlogo-nobg.png" width={80} height={80} alt="PrimeFlow Logo" /> 
        </div>
        <h3 className="text-3xl font-bold text-white mb-2">Crie sua conta</h3>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex items-start gap-3 py-2">
          ...
          <label className="text-xs text-slate-500">
            Concordo com os <a href="#" className="text-indigo-400">Termos</a> e a{" "}
            <a href="#" className="text-indigo-400">Política de Privacidade</a>.
          </label>
        </div>
      ...
      <p className="mt-8 text-center text-sm text-slate-500">
        Já tem conta?{" "}
        <button onClick={() => setView("login")} className="text-indigo-400 font-bold hover:underline">
          Faça Login
        </button>
      </p>
    </div>
